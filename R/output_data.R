...
output_data_list<-function(loc){
  ...
  NUS_cases_output<-cbind(2011:2020,(NUS_cases_output[[3]][19:28]/NUS_cases_output[[1]][59:68])*100)
  ...
  TB_deaths_output<-cbind(2004:2018,TB_deaths_output*1e6)
  ##### Unused Checks #####
  ...
  # pop_output<-as.data.frame(cbind(1950:2019,(pop_output[,1]+pop_output[,2]),pop_output[,1],pop_output[,2]))
  ...
  # mortality_output<-as.data.frame(cbind(1950:2019,mortality_output))
  #
  ...
  # NUS_recent_cases_output<-cbind(2011:2020,NUS_recent_cases_output[19:28])
